...
$string['configeachattemptbuildsonthelast'] = 'If multiple attempts are allowed then each new attempt contains the results of the previous attempt. Can be set even if only one attempt is allowed to prepare for possible overrides.';
